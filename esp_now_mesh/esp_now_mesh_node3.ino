...
// Node configuration
#define NODE_ID 3  // IMPORTANT: Each node must have a unique ID (1, 2, 3, etc.)
const char* NODE_NAME = "Node3"; // Human-readable name
...
void loop() {
  ...
  if (M5.BtnA.wasPressed()) {
    // For Node 3, cycle between sending to Node 1 and Node 2
    static uint8_t destNode = 1;  // Start with Node 1
    ...
    // Toggle between Node 1 and Node 2 for next press
